...
jest.mock('../proofs/da-proof-verifier');
...
import { DaProofVerifier } from '../proofs/da-proof-verifier';
  ...
  describe('post', () => {
    describe('with delegate', () => {
      ...
      beforeEach(() => {
        ...
        jest
          .spyOn(DaProofVerifier.prototype, 'extractAddress')
          .mockImplementation(async () => '0x123');
        jest
          .spyOn(DaProofVerifier.prototype, 'verifyTimestampSignature')
